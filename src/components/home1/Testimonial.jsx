...
const Testimonial = () => {
  ...
  const testimonials = [
    {
      ...
      image: "https://i.ibb.co.com/wZLrXDZV/team-7.jpg",
    ...
    },
    {
      name: "Dayana Maliha",
      position: "Founder, CEO",
      image: "https://i.ibb.co.com/4ZLhhz0X/team-1.jpg",
    ...
    },
    {
      name: "Rovert nikson",
      position: "Founder, CEO",
      image: "https://i.ibb.co.com/mVFVqLgS/team-8.jpg",
  ...
  return (
    <section
    className="zirox-testimonials zirox-testimonials--home-2 zirox-section relative bg-cover bg-center"
    style={{
      backgroundImage: `url('https://i.ibb.co.com/ymCJw3h5/clients.jpg')`,
    }}
  >
      ...
      <Slider {...settings} className="zirox-home-2-testimonials-items">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="zirox-testimonials__item">
            ...
            <address className="zirox-testimonials__item-address">
              {testimonial.address}
            </address>
