    ...
    <section className="zirox-blog zirox-section">
      <div className="container">
        ...
        <h2 data-aos="fade-up" data-aos-delay="300" className="text-center">
          Our Latest From The News & Articles
        </h2>
        <div className="row">
          <div data-aos="fade-up" className="col-12 col-md-6 col-lg-4">
            <div className="zirox-blog__post ">
              ...
              <div className="zirox-blog__post-body">
                ...
                <p className="zirox-blog__post-body-desc">Duis aute irure dolor in voluptate velit dolore eu fugiat nulla pariatur.</p>
                <a href="#" target="_blank" className="zirox-blog__post-body-read-more">
